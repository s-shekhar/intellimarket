...
(function ($) {
    ...
    jQuery(document).ready(function () {
       ...
       /* Mobile Navigation Hide or Collapse on Click */
        ...
        $(".typing").typed({
            strings: ["Guided By Prof.Karthikeyan T.","IntelliMarket Predicts Stock.", "This website helps in Analyzing current stocks too.", "Made by Passtionate Software Engineering Students."],    /* You can change the home section typing text from
